...
const InlineView = forwardRef(function InlineView({ diffs, currentChange }, ref) {
  ...
  return (
    <div style={{ height: '100%', overflowY: 'auto', padding: '1rem', background: 'var(--background)', WebkitOverflowScrolling: 'touch' }} ref={containerRef}>
      <pre style={{
        fontFamily: 'var(--font-sans)', fontSize: '0.9375rem', lineHeight: 1.75,

  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, position: 'relative', overflow: 'hidden' }}>
        {loading ? (
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', gap: '0.75rem', color: 'var(--muted-foreground)', minHeight: 200 }}>
          ...
          <textarea value={value} onChange={e => onChange(e.target.value)} spellCheck={false}
            style={{
              width: '100%', height: '100%', minHeight: isMobile ? 200 : 240,
              padding: isMobile ? '0.875rem' : '1rem', background: 'transparent', border: 'none',
              fontFamily: 'var(--font-sans)', fontSize: isMobile ? '0.9375rem' : '0.875rem',
              lineHeight: 1.7, color: 'var(--foreground)', resize: 'none', outline: 'none',
            }} />
        ) : (
          <div style={{
            display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center',
            height: '100%', gap: '0.625rem', padding: '2rem', textAlign: 'center',
            ...
            <p style={{ fontSize: '0.875rem', color: 'var(--muted-foreground)', lineHeight: 1.5 }}>
              {isMobile ? 'Tap Upload or paste text' : 'Paste text or drag & drop a file'}
            </p>
